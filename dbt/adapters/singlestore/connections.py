    ...
    def __post_init__(self):
        ...
        if (
            ...
            raise dbt.exceptions.RuntimeException(
                ...
                f"On SingleStore, database must be omitted or have the same value as"
                f" schema."
            )
        self.database = None
...
class SingleStoreConnectionManager(SQLConnectionManager):
    ...
    def open(cls, connection):
        ...
        try:
            ...
            logger.debug("Got an error when attempting to open a singlestore "
                         "connection: '{}'"
                         .format(e))
    ...
    def exception_handler(self, sql):
        try:
            ...
            logger.debug('SingleStore error: {}'.format(str(e)))
    ...
    def get_response(cls, cursor) -> AdapterResponse:
        ...
        return AdapterResponse(
            _message="{} ({}) ROWS AFFECTED".format(code, cursor.rowcount),
